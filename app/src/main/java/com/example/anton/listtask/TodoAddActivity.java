...
public class TodoAddActivity extends AppCompatActivity {
    ...
    private int Selected_Project_Id = -1;
    ...
    public void create_todo()
    {
        ...
        if(Title_todo.length() == 0)
        {
            Toast toast = Toast.makeText(getApplicationContext(),
                    "Введите название задачи!", Toast.LENGTH_SHORT);
            toast.show();
            return;
        }
        ...
        {
            Toast toast = Toast.makeText(getApplicationContext(),
                    "Не выбрана категория!", Toast.LENGTH_SHORT);
            toast.show();
            return;
        }
        ...
        Ion.with(TodoAddActivity.this)
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        Toast toast = Toast.makeText(getApplicationContext(),
                                "Задача успешно добавлена!", Toast.LENGTH_SHORT);
                        toast.show();
